...
public class PizzaService {
    ...
    // forma de ejecutar sentencias con jdbc y sql nativo
    public List<PizzaEntity> getAllAvaliableJdbc() {
        return this.jdbcTemplate.query("SELECT * FROM pizza WHERE avaliable = 1", BeanPropertyRowMapper<>(PizzaEntity.class));
    }
